...
const ProductsManager = () => {
    ...
    const handleUploadInput = e => {
        ...
        if (files.length === 0) return dispatch({ type: 'NOTIFY', payload: { error: 'Files does not exits.' } })
        files.forEach(file => {
        ...
        <div className="products_manager">
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    <textarea name="description" id="description" cols="30" rows="4" placeholder="Description" onChange={handleChangeInput} className="d-block my-4 w-100 p-2" value={description} />

                    <textarea name="content" id="content" cols="30" rows="6" placeholder="Content" onChange={handleChangeInput} className="d-block my-4 w-100 p-2" value={content} />
