        ...
        patchData(`order/delivered/${order._id}`, null, auth.token)
            .then(res => {
                ...
                dispatch(updateItem(orders, order._id, {
                    ...order, paid: paid, dateOfPayment, method, delivered
                }, 'ADD_ORDERS'))
                    ...
                    <div key={order._id} style={{ margin: '20px auto' }} className="row justify-content-around">
                        <div className="text-uppercase my-3" style={{ maxWidth: '600px' }}>
                            ...
                            <div className="mt-4 text-secondary">
                                ...
                                <div className={`alert ${order.delivered ? 'alert-success' : 'alert-danger'} d-flex justify-content-between align-item-center`} role="alert">
                                    {
                                ...
                                <div className={`alert ${order.paid ? 'alert-success' : 'alert-danger'} d-flex justify-content-between align-item-center`} role="alert">
                                    {
                                ...
                                <div>
                                    ...
                                    {
                                        order.cart.map(item => (
                                            <div className="row border-bottom mx-0 p-2 justify-content-between align-center" key={item._id} style={{ maxWidth: '550px' }}>
